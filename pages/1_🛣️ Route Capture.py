...
if st.session_state["mostrar_resumen"]:
    ...
    if st.button("✅ Save route"):
        ...
        data_row = {
            ...
            "Charge_MEX": r.get("cargo_mex", 0.0),
            ...
            "Diesel": r["diesel_rate"],
            "Truck_performance": r["rendimiento"],
            "Dollar_exchange_rate": r["tc"],
            "Pay_KM_USA": r["pay_km"],
            ...
            "Income_Fuel_USA": r["income_fuel_usa"],
            "Charge_Fuel_USA": r["charge_fuel_usa"],
            ...
            "Demoras/Detention": r["demoras"],
            "Movimiento_Extraordinario": r["movimiento_extra"],
            ...
            "Income_Cruce_Total": r["income_cruce"],
            "Charges_USA": r["charges_usa"],
            "Crossborder_Charge_Total": r["cargo_cruce_final"],
            "Indirect_Costs": r["costos_indirectos"],
            "Charge_MEX_Total": r["charges_mex"],
            "Salary_MEX": r["salary_mex"],
        }
        try:
